...
<pdf>
            ...
            <table style="width: 100%; margin-top: 10px;">
                ...
                <#if record.customer.custentity_mx_sat_registered_name?has_content>
                    <td colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                        ${record.customer.custentity_mx_sat_registered_name}<br/><br/>
                        <b>RFC:</b> <#outputformat "XML">${record.custbody_mx_customer_rfc?upper_case}</#outputformat><br/>
                        <#if record.entity.custentity_mx_sat_industry_type?has_content>
                            <br /><b>Regimen Fiscal:</b> ${record.entity.custentity_mx_sat_industry_type?upper_case}
                        </#if>
                    </td>
                        <#else>
                        <td colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                            ${record.customer.altname}<br/><br/>
                            <b>RFC:</b> <#outputformat "XML">${record.custbody_mx_customer_rfc?upper_case}</#outputformat>
                            <#if record.entity.custentity_mx_sat_industry_type?has_content>
                                <br /><b>Regimen Fiscal:</b> ${record.entity.custentity_mx_sat_industry_type?upper_case}
                            </#if>
                        </td>
    ...
    <table class="body" style="width: 100%; margin-top: 9px;">
        ...
        <tr>
            ...
            <td colspan="3" style="font-size:9px;">${record.exchangerate?string("0.####")}</td>
...
<td colspan= "18" style="width: 100%; font-size:10px;">${record.memo}</td>
    ...
    <table style="width: 100%; margin-top: 10px; padding: 0; border: 0px; border-color: #e3e3e3;">
        ...
        <tr>
            <td colspan="1" style="font-size: 7pt;"><b>Tipo de Comprobante:</b></td>
            <td colspan="2" style="font-size: 7pt;">E- Egreso</td>
    ...
    <#if certData?has_content>
        <table class="total" style="width: 100%; margin-top: 10px; border-left: 1px; border-color: #e3e3e3;">
            ...
            <#if record.custbody_efx_fe_related_cfdi_json?has_content>
                <tr>
                    <td style="border-left: 1px;border-right: 1px; border-color: #e3e3e3;font-size:90%;"><b>Documentos Relacionados:</b></td>
                </tr>
                <#assign relatedOBJ = record.custbody_efx_fe_related_cfdi_json>
                <#if relatedOBJ?has_content>
                    <#assign obj = relatedOBJ?eval>
                    <#list obj as objeto>
                        <tr>
                            <td style="border-left: 1px;border-right: 1px; border-color: #e3e3e3;font-size:90%; padding-left: 12px;font-size: 6pt;">
                                Folio: &nbsp; ${objeto.fol}
                            </td>
                        </tr>
                        <tr>
