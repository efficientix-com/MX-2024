...
<#if transaction.custbody_mx_txn_sat_payment_method?has_content>
...
<#assign envio_aux = transaction.shippingcost?string["0.00"]>
<#if transaction.shippingcost?length gt 0 && envio_aux?number gt 0>
