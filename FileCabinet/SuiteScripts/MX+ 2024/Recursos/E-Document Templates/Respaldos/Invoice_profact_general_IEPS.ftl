...
<#if transaction.custbody_efx_fe_kiosko_folio?has_content>
${getAttrPair("Folio",transaction.custbody_efx_fe_kiosko_folio)}
<#else>
...
Version="3.3"
<#assign total_desc_cabecera = desglose_cab.descuento?number>
...
<#assign json_descuentos = desglose.descuentoConImpuesto>
