...
<cfdi:Impuestos>
    <#if desglose.iva.name?has_content || desglose.ieps.name?has_content>
    <cfdi:Traslados>
...
<cfdi:Traslados>
    <#assign totales_ivas = 0>
    <#assign totales_ieps = 0>
    <#list custom.items as customItem>
    <#assign "item" = transaction.item[customItem.line?number]>
    <#assign desglose_json = item.custcol_efx_fe_tax_json>
    <#assign desglose = desglose_json?eval>
    <#assign monto_linea = item.amount>
    <#assign monto_linea_imp_iva = monto_linea * desglose.iva.rate_div?number>
    <#assign monto_linea_imp_ieps = monto_linea * desglose.ieps.rate_div?number>

    <#assign tasa_c_ieps = desglose.ieps.rate_div?number?string["0.000000"]>
    <#assign tasa_c_iva = desglose.iva.rate_div?number?string["0.000000"]>

    <#assign totales_ivas = totales_ivas + monto_linea_imp_iva>
    <#assign totales_ieps = totales_ieps + monto_linea_imp_ieps>

    <#if desglose.iva.name?has_content>
    <cfdi:Traslado Importe="${desglose.iva.importe?number?string["0.00"]}" Impuesto="002" TasaOCuota="${tasa_c_iva}" TipoFactor="Tasa" />
</#if>
<#if desglose.ieps.name?has_content>
<cfdi:Traslado Importe="${desglose.ieps.importe?number?string["0.00"]}" Impuesto="003" TasaOCuota="${tasa_c_ieps}" TipoFactor="Tasa" />
</#if>
</#list>
</cfdi:Traslados>
</cfdi:Impuestos>
