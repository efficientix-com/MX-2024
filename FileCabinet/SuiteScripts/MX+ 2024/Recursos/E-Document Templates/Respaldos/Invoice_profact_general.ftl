...
<#if desglose_cab.retencion_total != "0.00" && summary.includeTransfers == "true">
<cfdi:Impuestos TotalImpuestosRetenidos="${desglose_cab.retencion_total?number?string["0.00"]}" <#if transaction.shippingcost?length gt 0>TotalImpuestosTrasladados="${(total_tras?number + impuesto_envio_total?number)?string["0.00"]}"><#else>TotalImpuestosTrasladados="${total_tras?number?string["0.00"]}"></#if>
...
<cfdi:Impuestos <#if transaction.shippingcost?length gt 0>TotalImpuestosTrasladados="${(summary.totalNonWithHoldTaxAmt?number + impuesto_envio_total?number)?string["0.00"]}"<#else>TotalImpuestosTrasladados="${summary.totalNonWithHoldTaxAmt?number?string["0.00"]}" </#if>>
</#if>
