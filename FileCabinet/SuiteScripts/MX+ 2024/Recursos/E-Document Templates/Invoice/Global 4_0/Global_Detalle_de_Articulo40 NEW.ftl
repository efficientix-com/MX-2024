...
<cfdi:Comprobante
        ...
        <#if LeyendaFiscal == true>
            <#assign xsischemalocation_leyfisc = " http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd http://www.sat.gob.mx/leyendasFiscales http://www.sat.gob.mx/sitio_internet/cfd/leyendasFiscales/leyendasFisc.xsd">
        </#if>
        ...
        <#list custom.items as customItem>
            ...
            <#if customItem.amount?number gt 0>
    ...
    <cfdi:Receptor ${getAttrPair("Nombre", customer.custentity_mx_sat_registered_name)}
    ...
    <cfdi:Conceptos>
        <#list custom.items as customItem>
            ...
            <#else>
                <#if customItem.satUnitCode?has_content>
            ...
            <#if customItem.amount?number gt 0>
                ...
                <#assign desglose = desglose_json?eval>
                    ...
                    <#if desglose.ieps.importe?has_content || desglose.iva.importe?has_content>
                        <#assign objimp = "02">
                    <#else>
                        <#assign objimp = "01">
                    </#if>
            ...
            <cfdi:Concepto
                    ...
                    <#assign descripcion_item = item.description?replace("<br />","")>
                    <#assign descripcion = descripcion_item?replace("'","")>
                    ...
                    <#assign amount = customItem.amount?number>
                    <#assign cantidad = customItem.quantity?number>
                    <#assign item_rate =  amount / cantidad>
                    ValorUnitario="${item_rate?string["0.00"]}"
                    Descuento="${desglose.descuentoSinImpuesto?number?string["0.00"]}" ObjetoImp="${objimp}">
                    ...
                    <cfdi:Impuestos>
                        ...
                        <#assign tiene_impuesto = tiene_impuesto + 1>
                            <cfdi:Traslados>
                                    ...
                                    <#if obj_totales_imp?has_content>
                                        ...
                                        <#list obj_totales_imp?keys as key>
                                            <#if key?number == desglose.iva.rate?number>
                                                ...
                                                <#assign "total_rate_base" = obj_totales_imp_base[key]?number + desglose.iva.base_importe?number>
                                                <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.iva.rate : total_rate_base?number}>

                                            </#if>
                                        </#list>
                                        <#if conteos == 0>
                                            <#assign "obj_totales_imp"= obj_totales_imp + {desglose.iva.rate : desglose.iva.importe?number}>
                                            <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.iva.rate : desglose.iva.base_importe?number}>
                                        </#if>
                                    <#else>
                                        <#assign "obj_totales_imp"= obj_totales_imp + {desglose.iva.rate : desglose.iva.importe?number}>
                                        <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.iva.rate : desglose.iva.base_importe?number}>
                                    ...
                                    <#if obj_totales_imp?has_content>
                                        ...
                                        <#list obj_totales_imp?keys as key>
                                            ...
                                            <#if key == desglose.ieps.rate>
                                                ...
                                                <#assign "total_rate_base" = obj_totales_imp_base[key]?number + desglose.ieps.base_importe?number>
                                                <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.ieps.rate : total_rate_base?number}>
                                        ...
                                        <#if conteos == 0>
                                            ...
                                            <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.ieps.rate : desglose.ieps.base_importe?number}>
                                        </#if>
                                    <#else>
                                        <#assign "obj_totales_imp"= obj_totales_imp + {desglose.ieps.rate : desglose.ieps.importe?number}>
                                        <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.ieps.rate : desglose.ieps.base_importe?number}>
                                ...
                                <#assign "tieneExento" = tieneExento+1>
                                <#if obj_totales_imp?has_content>
                                        <#assign "conteos" = 0>
                                        <#list obj_totales_imp?keys as key>

                                            <#if key == desglose.exento.name>
                                                <#assign "conteos" = 1>

                                                <#assign "total_rate" = 0>
                                                <#assign "obj_totales_imp"= obj_totales_imp + {desglose.exento.name : total_rate?number}>

                                                <#assign "total_rate_base" = obj_totales_imp_base[key]?number + desglose.exento.base_importe?number>
                                                <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.exento.name : total_rate_base?number}>

                                            </#if>
                                            <#assign "keyses"= obj_totales_imp[key]>
                                        </#list>
                                        <#if conteos == 0>
                                            <#assign "obj_totales_imp"= obj_totales_imp + {desglose.exento.name : 0}>
                                            <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.exento.name : desglose.exento.base_importe?number}>
                                        </#if>
                                    <#else>
                                        <#assign "obj_totales_imp"= obj_totales_imp + {desglose.exento.name : 0}>
                                        <#assign "obj_totales_imp_base"= obj_totales_imp_base + {desglose.exento.name : desglose.exento.base_importe?number}>
...
<#else>
    ...
    <#if tieneobjimp gt 0>
        ...
        <#elseif obj_totales_imp?has_content || tieneExento gt 0>
            ...
            <#if obj_totales_imp?has_content>
                <cfdi:Traslados>
                    ...
                    <#list obj_totales_imp as Ieps_rate, Ieps_total>
                        ...
                        <#if Ieps_rate != "16" && Ieps_rate != "0" && Ieps_rate != "Exento">
                            <cfdi:Traslado Base="${obj_totales_imp_base[Ieps_rate]?string["0.00"]}" Importe="${Ieps_total?number?string["0.00"]}" Impuesto="002" TasaOCuota="${ieps_tasaocuota?string["0.000000"]}" TipoFactor="Tasa" />
                        </#if>
                    </#list>

                    <#list obj_totales_imp as exento_rate, exento_total>
                        <#if exento_rate == "Exento">
                            <cfdi:Traslado Base="${obj_totales_imp_base[exento_rate]?string["0.00"]}" Impuesto="001" TipoFactor="Exento" />
                        </#if>
                    </#list>
                    ...
                    <#list obj_totales_imp as Iva_rate, Iva_total>
                        ...
                        <#if (Iva_rate == "16" || Iva_rate == "0")  && Iva_rate != "Exento">
