                                                                                                                ...
                                                                                                                <#assign "itemSatCodes"=satCodes.items[customItem.line?number]>
                                                                                                                    ...
                                                                                                                    <#if item.custcol_efx_fe_gbl_sendtype==false>
                                                                                                                        <cfdi:Concepto
                                                                                                                            ...
                                                                                                                            Importe="${(item.custcol_efx_fe_subtotal_gbl?number - desglose.descuentoSinImpuesto?number)?string["0.00"]}"
                                                                                                                            NoIdentificacion="Transaccion: ${item.custcol_efx_fe_gbl_related_tran}"
                                                                                                                            ValorUnitario="${(item.custcol_efx_fe_subtotal_gbl?number - desglose.descuentoSinImpuesto?number)?string["0.00"]}"
                                                                                                                                                                            ...
                                                                                                                                                                            <#if key==iva_l_rate>
                                                                                                                                                                                <#assign "conteos"=1>
                                                                                                                                                                                    <#assign "total_rate"=obj_totales_imp[key]?number + iva_l_total_s?number>
                                                                                                                                                                                        <#assign "obj_totales_imp"=obj_totales_imp + {iva_l_rate?number : total_rate?number}>
                                                                                                                                                                            </#if>
                                                                                                                                                                        </#list>
                                                                                                                                                                        <#if conteos==0>
                                                                                                                                                                            <#assign "obj_totales_imp"=obj_totales_imp + {iva_l_rate?number : iva_l_total_s?number}>
                                                                                                                                                                        </#if>
                                                                                                                                                                        <#else>
                                                                                                                                                                            <#assign "obj_totales_imp"=obj_totales_imp + {iva_l_rate?number : iva_l_total_s?number}>
                                                                                                                                                                </#if>
