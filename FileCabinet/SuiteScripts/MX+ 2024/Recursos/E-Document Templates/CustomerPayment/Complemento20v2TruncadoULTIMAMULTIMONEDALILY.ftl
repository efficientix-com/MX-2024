...
<cfdi:Comprobante xmlns:pago20="http://www.sat.gob.mx/Pagos20" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xsi:schemaLocation="http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd http://www.sat.gob.mx/Pagos20 http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos20.xsd"
    ...
    <cfdi:Complemento>
        <pago20:Pagos Version="2.0">
            ...
            <pago20:Totales <#if currencyCode==transaction.custbody_efx_fe_moneda.symbol> <#assign monto_multimoneda = (monto_total_pago / tipocambioCustom)?string["0.00"]> MontoTotalPagos="${(monto_multimoneda?number * tipocambioCustom)?string["0.00"]}"<#elseif currencyCode=="EUR">MontoTotalPagos="${(montoTotalPago*transaction.exchangerate)?string["0.00"]}"<#else>MontoTotalPagos="${montoTotalPago?string["0.00"]}"</#if>
            <#if esTrasladoIva==true>
                <#if totaltrasladosiva16base gt 0>
                    ...
                    <#if transaction.custbody_efx_fe_moneda.symbol == "USD" && transaction.currencysymbol == "MXN"><#assign ImportePIVA16 = (totaltrasladosiva16)> <#assign importe_multimoneda = (totaltrasladosiva16 / tipocambioCustom)?string["0.00"]> TotalTrasladosImpuestoIVA16="${(importe_multimoneda?number * tipocambioCustom)?string["0.00"]}"<#elseif transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD"><#assign ImportePIVA16 = (totaltrasladosiva16/tipocambioCustom)?string("##0.00;; roundingMode=down")>TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16/tipocambioCustom)?string("##0.00;; roundingMode=down")}"<#elseif currencyCode=="EUR">TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*transaction.exchangerate)?string["0.00"]}"<#assign ImportePIVA16 = (totaltrasladosiva16*transaction.exchangerate)?string["0.00"]><#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*transaction.exchangerate)?string["0.00"]}"<#assign ImportePIVA16 = (totaltrasladosiva16*transaction.exchangerate)?string["0.00"]><#else>TotalTrasladosImpuestoIVA16="${totaltrasladosiva16?string["0.00"]}"<#assign ImportePIVA16 = totaltrasladosiva16?string["0.00"]></#if>
                </#if>
