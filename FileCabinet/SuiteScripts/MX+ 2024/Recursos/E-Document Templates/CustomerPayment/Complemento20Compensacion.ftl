        ...
        <pago20:Pagos xmlns:pago20="http://www.sat.gob.mx/Pagos20" Version="2.0">
            ...
            <#if esTrasladoIva==true>
                <#if totaltrasladosiva16base gt 0>
                    ...
                    <#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16/tipocambioCustom)?string("##0.00;; roundingMode=down")}"<#elseif currencyCode=="EUR">TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*transaction.exchangerate)?string["0.00"]}"<#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>TotalTrasladosImpuestoIVA16="${(totaltrasladosiva16*transaction.exchangerate)?string["0.00"]}"<#else>TotalTrasladosImpuestoIVA16="${totaltrasladosiva16?string["0.00"]}"</#if>
                </#if>
                <#if totaltrasladosiva8base gt 0>
                    <#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">TotalTrasladosBaseIVA8="${(totaltrasladosiva8div/0.08)?string["0.00"]}"<#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>TotalTrasladosBaseIVA8="${(totaltrasladosiva8div*transaction.exchangerate)?string["0.00"]}"<#else>TotalTrasladosBaseIVA8="${totaltrasladosiva8div?string["0.00"]}"</#if>
                ...
                <#if totaltrasladosiva0base gt 0>
                    <#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">TotalTrasladosBaseIVA0="${(totaltrasladosiva0div)?string["0.00"]}"<#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>TotalTrasladosBaseIVA0="${(totaltrasladosiva0base*transaction.exchangerate)?string["0.00"]}"<#else>TotalTrasladosBaseIVA0="${totaltrasladosiva0base?string["0.00"]}"</#if>
                                        ...
                                        <pago20:TrasladosDR>
                                            ...
                                            <#list impuestosPago.bases_ieps as iepsRate, iepsValue>
                                                ...
                                                <#if ImpuestosPTraslados_importe?has_content>
                                                    ...
                                                    <#if conteos == 0>
                                                        <#assign "ImpuestosPTraslados_importe"= ImpuestosPTraslados_importe + {iepsRate : ((impuestosPago.rates_ieps_data[iepsRate]?number*equivalenciaImpuesto)?string['0.00'])?number}>
                                                    </#if>
