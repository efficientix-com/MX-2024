                        ...
                        <#list custom.appliedTxns as appliedTxn>
                            <#if key == appliedTxn.custbody_mx_cfdi_folio>
                                ...
                                <#assign impinsoluto = txnitem.disc>
                                    ...
                                    <pago10:DoctoRelacionado IdDocumento="${appliedTxn.custbody_mx_cfdi_uuid}" ${getAttrPair("Folio",foliorelated_folio)} ${getAttrPair("Serie",foliorelated_serie)} MonedaDR="${appliedTxnCurrency}" <#if transaction.custbody_efx_fe_moneda?has_content &&  transaction.custbody_efx_fe_importe?has_content>TipoCambioDR="${transaction.custbody_efx_fe_tipo_cambio}"<#elseif transaction.custbody_efx_fe_tipo_cambio_factura == true>TipoCambioDR="${obj_line_tcambio[key].t_cambio}"</#if> MetodoDePagoDR="${invPaymentTerm}" NumParcialidad="${appliedTxn.order}" ImpSaldoAnt="${(ImpSaldoAnt)?string["0.00"]}" ImpPagado="${txnitem.amount?string["0.00"]}" ImpSaldoInsoluto="${impinsoluto?string["0.00"]}" />
                                <#else>
                                    <pago10:DoctoRelacionado IdDocumento="${appliedTxn.custbody_mx_cfdi_uuid}" ${getAttrPair("Folio",foliorelated_folio)} ${getAttrPair("Serie",foliorelated_serie)} MonedaDR="${appliedTxnCurrency}" <#if transaction.custbody_efx_fe_moneda?has_content &&  transaction.custbody_efx_fe_importe?has_content>TipoCambioDR="${transaction.custbody_efx_fe_tipo_cambio}"</#if> MetodoDePagoDR="${invPaymentTerm}" NumParcialidad="${appliedTxn.order}" ImpSaldoAnt="${(ImpSaldoAnt)?string["0.00"]}" ImpPagado="${txnitem.amount?string["0.00"]}" ImpSaldoInsoluto="${impinsoluto?string["0.00"]}" />
                                </#if>
                            </#if>
                        </#list>
                    </#list>
            ...
            <#if transaction.custbody_efx_fe_chbx_factorage == true>
                ...
                >
                    <#list custom.appliedTxns as appliedTxn>
                        ...
                        <pago10:DoctoRelacionado IdDocumento="${appliedTxn.custbody_mx_cfdi_uuid}" ${getAttrPair("Folio",foliorelated_folio)} ${getAttrPair("Serie",foliorelated_serie)} MonedaDR="${appliedTxnCurrency}" <#if transaction.custbody_efx_fe_moneda?has_content &&  transaction.custbody_efx_fe_importe?has_content>TipoCambioDR="${transaction.custbody_efx_fe_tipo_cambio}"</#if> MetodoDePagoDR="${invPaymentTerm}" NumParcialidad="${appliedTxn.order?number + 1}" ImpSaldoAnt="${ImpSaldoAnt?string["0.00"]}" ImpPagado="${txnitem.disc?string["0.00"]}" ImpSaldoInsoluto="${impinsoluto?string["0.00"]}" />
                    </#list>
