...
<pdf>
                        ...
                        <td rowspan="3" style="width: 30%;">
                            <#if certData?has_content>
                                <#if record.custbody_efx_fe_logosub?has_content>
                                    <img height="35%" src="${record.custbody_efx_fe_logosub}"
                                         style="float: left; margin: 2px" width="2in"/>
                                </#if>
                            <#else>
                                <#if record.custbody_efx_fe_logosub?has_content>
                                    <#if subsidiary.logo@url?length != 0>
                                        <img height="35%" src="${subsidiary.logo@url}" style="float: left; margin: 2px"
                                             width="2in"/>
                                    <#elseif companyInformation.logoUrl?length != 0>
                                        <img height="35%" src="${companyInformation.logoUrl}"
                                             style="float: left; margin: 2px" width="2in"/>
                                    </#if>
                                </#if>
                            </#if>
                        ...
                        <td colspan="4" style="font-size: 10px;" align="right">
                            ...
                            <#if dataXML?has_content>
                                <#assign folio_tran = dataXML.atributos.Serie +"-"+ dataXML.atributos.Folio>
                                  <#if folio_tran?has_content==false>
                                    <#assign folio_tran = record.tranid>
                                    </#if>
                                ...
                                <#elseif record.custbody_efx_fe_gbl_type?has_content>
                                    <p style="font-size: 12px; margin:0px"><strong>FACTURA GLOBAL</strong></p>
                                <#else>
                                    <p style="font-size: 12px; margin:0px"><strong>FACTURA</strong></p>
                                </#if>
                            ...
                            <p class="number" style="font-size: 8px; margin:0px"><b>CANAL DE
                                    VENTA: ${record.cseg_efx_cstsg_cana}</b></p>
                ...
                <table class="footer" style="width: 100%;">
                    <tr>
                        <#if record.custbody_efx_fe_gbl_folio?has_content>
                            <td>
                                <barcode codetype="code128" showtext="true" value="${record.custbody_efx_fe_gbl_folio}"
                                         style="height: 30px"/>
                            </td>
                        <#else>
                            <td>
    ...
    <body header="nlheader" header-height="8%" footer="nlfooter" footer-height="20pt" padding="0.2in 0.5in 0.2in 0.5in"
          size="Letter">
          <#if record.custbody_efx_fe_kiosko_customer?has_content>
            <#assign desglosa_cliente = record.custbody_efx_fe_kiosko_customer.custentity_efx_cmp_registra_ieps>
        <#else>
                ...
                <td class="cuerposinfogeneral" colspan="14" rowspan="2">
                    <table>
                        <tr>
                            ...
                            <#if record.entity.entityid?has_content>
                        ...
                        <tr>
                            ...
                            <td class="cuerpotablainfo">${record.custbody_efx_fe_kiosko_rsocial?upper_case?html?replace('AMP;',' ')}</td>
                            <#else>
                            <td class="cuerpotablainfo">${record.custbody_efx_fe_kiosko_name?upper_case?html?replace('AMP;',' ')}</td>
                            </#if>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <#if record.custbody_efx_fe_kiosko_address?has_content>
                ...
                <td class="cuerposinfogeneral" colspan="14" rowspan="2">
                    <table>
                        ...
                        <tr>
                            <td class="cuerpotablaetiqueta">Nombre:</td>
                            <#if record.entity.custentity_efx_fe_version?keep_after(" ") == "4.0">
                                <td class="cuerpotablainfo">${record.entity.custentity_mx_sat_registered_name?upper_case?html?replace('AMP;',' ')}</td>
                            <#else>
                                <#if record.entity.isperson>
                                    <td class="cuerpotablainfo">${record.entity.altname?upper_case?html?replace('AMP;',' ')}</td>
                                <#else>
                                    <td class="cuerpotablainfo">${record.entity.companyname?upper_case?html?replace('AMP;',' ')}</td>
                                </#if>
                            </#if>
                        </tr>
                        <#if dataXML?has_content>
    ...
    <table class="tablascompletas" style="margin-top:5px;">
        <tr>
            <td colspan="4" class="cabecera"><b>Términos de crédito</b></td>
            <td colspan="4" class="cabecera"><b>OC de Cliente</b></td>
            <td colspan="4" class="cabecera"><b>Orden de venta</b></td>
            <td colspan="4" class="cabecera"><b>Cotizaci&oacute;n</b></td>
            <!--<td colspan="3" class="cabecera"><b>OC de cliente</b></td>-->
        </tr>
        <tr>
            <td colspan="4" class="cuerposnoarticulos">${record.entity.terms}</td>
            <td colspan="4" class="cuerposnoarticulos">${record.otherrefnum}</td>
            <td colspan="4" class="cuerposnoarticulos">${record.createdfrom?keep_after("#")}</td>
            <td colspan="4" class="cuerposnoarticulos">${record.createdfrom.createdfrom?keep_after("#")}</td>
            <!--<#if record.custbody_efx_nota_interna?has_content>
                    <td colspan="3" class="cuerposnoarticulos">${record.custbody_efx_nota_interna}</td>
            <#else>
    ...
    <#if record.custbody_efx_fe_tax_json?has_content>
        <#assign "desglose_json_body" = record.custbody_efx_fe_tax_json>
        <#assign "desglose_body" = desglose_json_body?eval>
        <#assign "desglose_ieps" = desglose_body.rates_ieps>
        <#assign "desglose_iva" = desglose_body.rates_iva>
    ...
    <#else>
                    ...
                    <table style="width: 100%; margin: 0px; padding: 0; border: 0px; border-color: #e3e3e3;">
                        ...
                        <tr>
                            ...
                            <#elseif forma_pago == "03">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">03 - TRANSFERENCIA ELECTRÓNICA DE
                                    FONDOS
                                </td>
                            ...
                            <#elseif forma_pago == "27">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">27 - A SATISFACCIÓN DEL ACREEDOR
                                </td>
                        ...
                        <tr>
                            ...
                            <#if metodo_pago == "PUE">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">PUE - PAGO EN UNA SOLA
                                    EXHIBICION
                                </td>
                            <#elseif metodo_pago == "PPD">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">PPD - PAGO EN PARCIALIDADES O
                                    DIFERIDO
                                </td>
                            <#else>
                                <td colspan="2" style="font-size: 7pt; padding: 2px;"></td>
                        ...
                        <tr>
                            ...
                            <#if uso_cfdi == "D01">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D01 - HONORARIOS MÉDICOS, DENTALES
                                    Y GASTOS HOSPITALARIOS
                                </td>
                            <#elseif uso_cfdi == "D02">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D02 - GASTOS MÉDICOS POR
                            ...
                            <#elseif uso_cfdi == "D05">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D05 - INTERESES REALES
                                    EFECTIVAMENTE PAGADOS POR CRÉDITOS HIPOTECARIOS (CASA HABITACIÓN)
                                </td>
                            <#elseif uso_cfdi == "D06">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D06 - APORTACIONES VOLUNTARIAS AL
                                    SAR
                                </td>
                            <#elseif uso_cfdi == "D07">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D07 - PRIMAS POR SEGUROS DE GASTOS
                                    MÉDICOS
                                </td>
                            <#elseif uso_cfdi == "D08">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D08 - GASTOS DE TRANSPORTACIÓN
                                    ESCOLAR OBLIGATORIA
                                </td>
                            <#elseif uso_cfdi == "D09">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D09 - DEPÓSITOS EN CUENTAS PARA EL
                                    AHORRO, PRIMAS QUE TENGAN COMO BASE PLANES DE PENSIONES
                                </td>
                            <#elseif uso_cfdi == "D10">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">D10 - PAGOS POR SERVICIOS
                                    EDUCATIVOS (COLEGIATURAS)
                                </td>
                            <#elseif uso_cfdi == "G01">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">G01 - ADQUISICIÓN DE MERCANCÍAS
                                </td>
                            <#elseif uso_cfdi == "G02">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">G02 - DEVOLUCIONES, DESCUENTOS O
                                    BONIFICACIONES
                                </td>
                            <#elseif uso_cfdi == "G03">
                            ...
                            <#elseif uso_cfdi == "I02">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I02 - MOBILIARIO Y EQUIPO DE
                                    OFICINA POR INVERSIONES
                                </td>
                            <#elseif uso_cfdi == "I03">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I03 - EQUIPO DE TRANSPORTE</td>
                            <#elseif uso_cfdi == "I04">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I04 - EQUIPO DE CÓMPUTO Y
                                    ACCESORIOS
                                </td>
                            <#elseif uso_cfdi == "I05">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I05 - DADOS, TROQUELES, MOLDES,
                                    MATRICES Y HERRAMENTAL
                                </td>
                            <#elseif uso_cfdi == "I06">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I06 - COMUNICACIONES TELEFÓNICAS
                                </td>
                            <#elseif uso_cfdi == "I07">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I07 - COMUNICACIONES SATELITALES
                                </td>
                            <#elseif uso_cfdi == "I08">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">I08 - OTRA MAQUINARIA Y EQUIPO
                                </td>
                            <#elseif uso_cfdi == "P01">
                            ...
                            <td colspan="1" style="font-size: 7pt; padding: 2px; padding: 2px;"><b>Lugar de expedici&oacute;n:</b>
                            </td>
                            <td colspan="2"
                                style="font-size: 7pt; padding: 2px;">${record.location.custrecord_efx_lugar_expedicion?upper_case}</td>
                        </tr>
                        <tr>
                            ...
                            <#if regfiscal == "601">
                                <td colspan="2" style="font-size: 7pt; padding: 2px;">601 - GENERAL DE LEY PERSONAS
                                    MORALES
                                </td>
                            <#else>
                                <td colspan="2"
                                    style="font-size: 7pt; padding: 2px;">${record.subsidiary.custrecord_mx_sat_industry_type?upper_case}</td>
                            </#if>
                        </tr>
                        <#if record.entity.custbody_mx_cfdi_sat_export_type?has_content && record.entity.custentity_efx_fe_version?keep_after(" ") == "4.0">
                            <tr>
                ...
                <td colspan="2" style="margin: 0px; padding: 0; border-left: 1px; border-color: #e3e3e3;">
                    <table style="width: 100%; height: 100%; margin-top: 0px; margin-left: 0px; border: 0px; border-color: #e3e3e3;">
                        ...
                        <#if dataXML?has_content>
                            <tr>
                                ...
                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px">${dataXML.atributos.SubTotal?number?string[",##0.00"]}</td>
                                <#else>
                                    <#assign iepsdataxmlseqSubtotal = 0>
                                    <#if dataXML.Impuestos.Traslados.Traslado?is_sequence>

                                        <#list dataXML.Impuestos.Traslados.Traslado as traslados_lista>
                                            <#if traslados_lista.atributos.Impuesto == "003">
                                                <#assign iepsdataxmlseqSubtotal = iepsdataxmlseqSubtotal + traslados_lista.atributos.Importe?number>
                                            </#if>
                                        </#list>

                                    <#else>
                                        <#if dataXML.Impuestos.Traslados.Traslado.atributos.Impuesto == "003">
                                            <#assign iepsdataxmlseqSubtotal = dataXML.Impuestos.Traslados.Traslado.atributos.Importe?number>

                                        </#if>
                                    </#if>

                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px">${(dataXML.atributos.SubTotal?number + iepsdataxmlseqSubtotal)?string[",##0.00"]}</td>
                                </#if>
                            </tr>
                        <#else>
                            <tr>
                                <td colspan="1" style="font-size: 7pt; padding:2px"><b>Subtotal</b></td>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px">${subtotalwithieps?string[",##0.00"]}</td>
                            </tr>
                        </#if>
                        ...
                        <tr>
                            ...
                            <#if dataXML?has_content>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px">${dataXML.atributos.Descuento?number?string[",##0.00"]}</td>
                            <#else>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px"><#if record.custbody_efx_promo_desglosa_promo == true>0.00<#else>${desglose_total_discount?number?string[",##0.00"]}</#if></td>
                            </#if>
                        </tr>
                        ...
                        <#if desglosa_cliente==true>
                            <#if dataXML?has_content>
                                ...
                                <tr>
                                    ...
                                    <#if dataXML.Impuestos.Traslados.Traslado?is_sequence>
                                        <#assign iepsdataxmlseq = 0>
                                        <#list dataXML.Impuestos.Traslados.Traslado as traslados_lista>
                                            <#if traslados_lista.atributos.Impuesto == "003">
                                                <#assign iepsdataxmlseq = iepsdataxmlseq + traslados_lista.atributos.Importe?number>
                                            </#if>
                                        </#list>
                                        <td align="right" colspan="1"
                                            style="font-size: 7pt; padding:2px">${iepsdataxmlseq?string[",##0.00"]}</td>
                                    <#else>
                                        <#if dataXML.Impuestos.Traslados.Traslado.atributos.Impuesto == "003">
                                            <td align="right" colspan="1"
                                                style="font-size: 7pt; padding:2px">${dataXML.Impuestos.Traslados.Traslado.atributos.Importe?number?string[",##0.00"]}</td>
                                        <#else>
                                            <td align="right" colspan="1"
                                                style="font-size: 7pt; padding:2px">0.00</td>
                                        </#if>
                                    </#if>
                                </tr>
                            <#else>
                                <tr>
                                    <td colspan="1" style="font-size: 7pt;padding:2px"><b>IEPS</b></td>
                                    <td align="right" colspan="1"
                                        style="font-size: 7pt; padding:2px">${ieps_total?number?string[",##0.00"]}</td>
                                </tr>
                            </#if>
                        </#if>
                                        ...
                                        <tr>
                                            ...
                                            <#if traslados_lista.atributos.Impuesto=="003">
                                                <td colspan="2" style="font-size: 5pt;">
                                                    IEPS ${iva_ratenum}%: ${traslados_lista.atributos.Importe?number?string[",##0.00"]}
                                                    <br/>
                                                </td>
                                            </#if>
                                ...
                                <#else>
                                    ...
                                    <tr>
                                        <#if dataXML.Impuestos.Traslados.Traslado.atributos.Impuesto == "002">
                                            <td colspan="2" style="font-size: 5pt;">
                                                IVA ${iva_ratenum?string["0"]}%: ${dataXML.Impuestos.Traslados.Traslado.atributos.Importe?number?string[",##0.00"]}
                                                <br/>
                                            </td>
                                        <#elseif dataXML.Impuestos.Traslados.Traslado.atributos.Impuesto == "003">
                                            <td colspan="2" style="font-size: 5pt;">
                                                IEPS ${iva_ratenum?string["0"]}%: ${dataXML.Impuestos.Traslados.Traslado.atributos.Importe?number?string[",##0.00"]}
                                                <br/>
                                            </td>
                                        </#if>
                        ...
                        <#if dataXML?has_content==false>
                            <#if record.custbody_efx_fe_gbl_ismirror== true >
                                <tr>
                                    ...
                                    <td align="right" colspan="1"
                                        style="font-size: 7pt;padding:2px;">${totalivaGBL?number?string[",##0.00"]}</td>
                                </tr>
                            ...
                            <#else>
                                <tr>
                                    <td colspan="1" style="font-size: 7pt; padding:2px "><b>IVA</b></td>
                                    <td align="right" colspan="1"
                                        style="font-size: 7pt;padding:2px;">${iva_total?number?string[",##0.00"]}</td>
                                </tr>
                            </#if>
                            ...
                            <#if record.custbody_efx_fe_gbl_ismirror== true >
                                ...
                                <#list obj_totales_imp as Iva_rate, Iva_total>
                                    ...
                                    <#if Iva_rate == "16" || Iva_rate == "0">
                                        <tr>
                                            <td colspan="2" style="font-size: 5pt;">
                                                IVA ${Iva_rate}%: ${Iva_total?number?string[",##0.00"]}<br/>
                                            </td>
                                        </tr>
                                    </#if>
                                </#list>
                            ...
                            <#if local_total?has_content>
                                <tr>
                                    ...
                                    <td align="right" colspan="1"
                                        style="font-size: 7pt; padding:2px">${local_total?number?string[",##0.00"]}</td>
                                </tr>
                            </#if>
                        <#else>
                            <tr>
                                <td colspan="1" style="font-size: 7pt; padding:2px "><b>IVA</b></td>
                                <#if dataXML.Impuestos.Traslados.Traslado?is_sequence>
                                <#assign ivadataxmlseq = 0>
                                    <#list dataXML.Impuestos.Traslados.Traslado as traslados_lista>

                                        <#if traslados_lista.atributos.Impuesto=="002">
                                            <#assign ivadataxmlseq = ivadataxmlseq + traslados_lista.atributos.Importe?number>
                                        </#if>
                                    </#list>
                                    <td align="right" colspan="1"
                                        style="font-size: 7pt;padding:2px;">${ivadataxmlseq?string[",##0.00"]}</td>
                                <#else>
                                    <#if dataXML.Impuestos.Traslados.Traslado.atributos.Impuesto == "002">
                                        <td align="right" colspan="1"
                                            style="font-size: 7pt;padding:2px;">${dataXML.Impuestos.Traslados.Traslado.atributos.Importe?number?string[",##0.00"]}</td>
                                ...
                                <td colspan="2" style="font-size: 5pt; ">
                                    <#if dataXML.Impuestos.Traslados.Traslado?is_sequence>
                                        <#list dataXML.Impuestos.Traslados.Traslado as traslados_lista>
                                            <#assign iva_ratenum = traslados_lista.atributos.TasaOCuota?number * 100>
                                            <#if traslados_lista.atributos.Impuesto=="002">
                                                IVA ${iva_ratenum?string["0"]}%: ${traslados_lista.atributos.Importe?number?string[",##0.00"]}<br/>
                                            </#if>
                                        </#list>
                                    <#else>
                                        <#assign iva_ratenum = dataXML.Impuestos.Traslados.Traslado.atributos.TasaOCuota?number * 100>
                                        <#if dataXML.Impuestos.Traslados.Traslado.atributos.Impuesto == "002">
                                            IVA ${iva_ratenum?string["0"]}
                                            %: ${dataXML.Impuestos.Traslados.Traslado.atributos.Importe?number?string[",##0.00"]}
                                        </#if>
                                    </#if>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <#if dataXML?has_content>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px">${dataXML.atributos.Total?number?string[",##0.00"]}</td>
                            <#else>
                                <td align="right" colspan="1"
                                    style="font-size: 7pt; padding:2px">${cabecera_total?number?string[",##0.00"]}</td>
                            </#if>
                        </tr>
                    </table>
                </td>
        ...
        <table class="total" style="width: 100%; margin-top: 0px; border: 1px; border-color: #e3e3e3;">
            ...
            <tr>
                <td align="left" colspan="3"
                    style="border-bottom: 1px; border-color: #e3e3e3; font-size: 7pt; padding: 2px;"><strong>Cantidad
                        con letra:</strong> ${record.custbody_efx_fe_total_text}</td>
            </tr>
            <tr>
                <td align="left" style="border-right: 1px;  border-color: #e3e3e3; font-size: 7pt; padding: 2px;">
                    <strong>Elaboró: </strong>${record.custbody_efx_cmp_elaboro.firstname?upper_case} ${record.custbody_efx_cmp_elaboro.lastname?upper_case}
                </td>
                <td align="left" style="border-right: 1px;  border-color: #e3e3e3; font-size: 7pt; padding: 2px;">
                    <strong>Total de piezas: </strong>${total_piezas?string['0']}</td>
                <#if record.custbody_efx_fe_total_box?has_content>
                    <td align="left" style="font-size: 7pt; padding: 2px;"><strong>Total de
                            cartones: </strong>${record.custbody_efx_fe_total_box}</td>
                <#else>
    ...
    <table style=" margin-top: 5px; border: 1px; border-color: #e3e3e3;">
        ...
        <tr>
            <td colspan="1" style="font-size: 7pt; border-color: #e3e3e3;  padding: 2px;">
                - Solo se podrán realizar 30 días naturales posteriores a la fecha de emisión de la factura y para
                clientes Vinoclub a partir de la fecha de recepción. <br/>
                ...
                - No se aceptan devoluciones en promociones que incluyan dos a más productos bajo un mismo precio de
                venta.<br/>
                - En caso de recibir nuestro producto por medio de paquetería la solicitud de devolución deberá
                realizarse dentro de las primeras 48 horas siguientes a la recepción, especificando la razón de esta,
                motivo y su evidencia fotográfica.
            </td>
        </tr>
    </table>

    <#if record.custbody_efx_fe_gbl_type?has_content>
        <table style=" margin-top: 5px; border: 1px; border-color: #e3e3e3;" width="100%">
            <tr>
                <td colspan="9" class="cabecera"><b>Información Global</b></td>
            </tr>
            <tr>
                <td colspan="1" style="font-size: 7pt; border-color: #e3e3e3;  padding: 2px;">
                    Periodicidad
                </td>
                <td colspan="2" style="font-size: 7pt; border-color: #e3e3e3;  padding: 2px;">
                    ${record.custbody_efx_fe_periodicidad}
                </td>
            </tr>
            <tr>
                <td colspan="1" style="font-size: 7pt; border-color: #e3e3e3;  padding: 2px;">
            ...
            <tr>
                ...
                <td colspan="2" style="font-size: 7pt; border-color: #e3e3e3;  padding: 2px;">
                    ${record.custbody_efx_fe_anio?string}
                </td>
            </tr>
        </table>
    </#if>
    ...
    <#if record.recmachcustrecord_mx_rcs_orig_trans?has_content>
        <table style="width:100%; margin-top:5px; border: 1px;border-color:#e3e3e3;">
            ...
            <#list record.recmachcustrecord_mx_rcs_orig_trans as cfdiRel>
                <tr>
                    <td align="left" colspan="2"
                        style="padding:2px">${cfdiRel.custrecord_mx_rcs_rel_cfdi?keep_after("#")}</td>
                    ...
                    <#if cfdireltype == "01">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">01 - NOTA DE CRÉDITO
                            DE LOS DOCUMENTOS RELACIONADOS
                        </td>
                    <#elseif cfdireltype == "02">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">02 - NOTA DE DÉBITO
                            DE LOS DOCUMENTOS RELACIONADOS
                        </td>
                    <#elseif cfdireltype == "03">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">03 - DEVOLUCIÓN DE
                            MERCANCÍA SOBRE FACTURAS O TRASLADOS PREVIOS
                        </td>
                    <#elseif cfdireltype == "04">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">04 - SUSTITUCIÓN DE
                            LOS CFDI PREVIOS
                        </td>
                    <#elseif cfdireltype == "05">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">05 - TRASLADOS DE
                            MERCANCÍAS FACTURADOS PREVIAMENTE
                        </td>
                    <#elseif cfdireltype == "06">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">06 - FACTURA
                            GENERADA POR LOS TRASLADOS PREVIOS
                        </td>
                    <#elseif cfdireltype == "07">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">07 - CFDI POR
                            APLICACIÓN DE ANTICIPO
                        </td>
                    <#elseif cfdireltype == "08">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">08 - FACTURA
                            GENERADA POR PAGOS EN PARCIALIDADES
                        </td>
                    <#elseif cfdireltype == "09">
                        <td align="left" colspan="2" style="padding:2px" class="cuerposnoarticulos">09 - FACTURA
                            GENERADA POR PAGOS DIFERIDOS
                        </td>
                    <#else>
    ...
    <#if certData?has_content>
        <table class="tablascompletas" style="margin-top:5px;">
            ...
            <#if certData.custbody_mx_cfdi_certify_timestamp?has_content>
                <tr>
