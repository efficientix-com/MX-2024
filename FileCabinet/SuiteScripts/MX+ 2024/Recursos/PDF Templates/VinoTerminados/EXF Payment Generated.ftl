...
<pdf>
        ...
        <tr>
            <td colspan= "1">
                <table  style="width:100%;">
                    ...
                    <#assign rfc = record.custbody_efx_fe_dirsubs?keep_after_last("<br />")>
                    <tr>
            ...
            <td colspan= "1">
                <table style="width:100%;">
                    ...
                    <tr>
                    <#if record.customer.custentity_efx_fe_version?keep_after(" ") == "4.0">
                        <#if record.custbody_efx_fe_chbx_factorage==true>

                            <td><b>Razón social:</b> ${record.custbody_efx_fe_factoraje_receptor}</td>
                        <#else>
                    ...
                    <#if record.custbody_efx_fe_chbx_factorage==true>
                            ...
                            <td><b>Razón social:</b> ${record.custbody_efx_fe_factoraje_receptor}</td>
                        <#else>
                            <td><b>Razón social:</b> ${record.customer.altname}</td>
                        </#if>
                    </#if>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <#if record.customer.custentity_efx_fe_version?keep_after(" ") == "4.0">
                        <td><b>Uso CFDI:</b> CP01 - Pagos</td>
                    <#else>
                    <td><b>Uso CFDI:</b> P01 - Por Definir</td>
                    </#if>
                    </tr>
                    <tr>
                        <td><b>Domicilio fiscal:</b> ${record.customer.address?upper_case}</td>
                    </tr>
                    <tr>
                        
                        <#assign regifig = record.customer.custentity_mx_sat_industry_type?keep_before(" ")>

                    <#if regifig == "601">
                    <td><b>Régimen Fiscal: </b>601 - General de Ley Personas Morales</td>
                    <#elseif regifig == "603">
                    <td><b>Régimen Fiscal: </b>603 - Personas Morales con Fines no Lucrativos</td>
                    <#elseif regifig == "605">
                    <td><b>Régimen Fiscal: </b>605 - Sueldos y Salarios e Ingresos Asimilados a Salarios</td>
                    <#elseif regifig == "606">
                      <td><b>Régimen Fiscal: </b>606 - Arrendamiento</td>
                      <#elseif regifig == "607">
                      <td><b>Régimen Fiscal: </b>607 - Régimen de Enajenación o Adquisición de Bienes</td>
                     <#elseif regifig == "608">
                      <td><b>Régimen Fiscal: </b>608 - Demás ingresos</td>
                    <#elseif regifig == "609">
                      <td><b>Régimen Fiscal: </b>609 - Consolidación</td>
                    <#elseif regifig == "610">
                      <td><b>Régimen Fiscal: </b>610 - Residentes en el Extranjero sin Establecimiento Permanente en México</td>
                    <#elseif regifig == "611">
                      <td><b>Régimen Fiscal: </b>611 - Ingresos por Dividendos (socios y accionistas)</td>
                    <#elseif regifig == "612">
                      <td><b>Régimen Fiscal: </b>612 - Personas Físicas con Actividades Empresariales y Profesionales</td>
                    <#elseif regifig == "614">
                      <td><b>Régimen Fiscal: </b>614 - Ingresos por intereses</td>
                    <#elseif regifig == "615">
                      <td><b>Régimen Fiscal: </b>615 - Régimen de los ingresos por obtención de premios</td>
                    <#elseif regifig == "616">
                      <td><b>Régimen Fiscal: </b>616 - Sin obligaciones fiscales</td>
                    <#elseif regifig == "620">
                      <td><b>Régimen Fiscal: </b>620 - Sociedades Cooperativas de Producción que Optan por Diferir sus Ingresos</td>
                      <#elseif regifig == "621">
                      <td><b>Régimen Fiscal:</b>621 - Incorporación Fiscal</td>
                        <#elseif regifig == "622">
                      <td><b>Régimen Fiscal: </b>622 - Actividades Agrícolas, Ganaderas, Silvícolas Y Pesqueras</td>
                          <#elseif regifig == "623">
                      <td><b>Régimen Fiscal: </b>623 - Opcional para Grupos de Sociedades</td>
                            <#elseif regifig == "624">
                      <td><b>Régimen Fiscal: </b>624 - Coordinados</td>
                              <#elseif regifig == "628">
                      <td><b>Régimen Fiscal: </b>628 - Hidrocarburos</td>
                                <#elseif regifig == "629">
                      <td><b>Régimen Fiscal: </b>629 - De los Regímenes Fiscales Preferentes y de las Empresas Multinacionales</td>
                        <#elseif regifig == "630">
                      <td><b>Régimen Fiscal: </b>630 - Enajenación de acciones en bolsa de valores</td>
                    <#else>
            ...
            <td colspan= "1">
                <table>
                    ...
                    <tr>
                        ...
                        <td font-size="8pt">${record.tranid?keep_before("-")}</td>
                    </tr><tr>
                        <td font-size="8pt"><b>Folio</b></td>
                        <td font-size="8pt">${record.tranid?keep_after("-")}</td>
                    </tr><tr>
                        <td font-size="8pt"><b>Tipo Comprobante</b></td>
                        <td font-size="8pt">P Pago</td>
                    </tr><tr>
                        <td font-size="8pt"><b>Versión Comprobante</b></td>
                        <td font-size="8pt">${record.customer.custentity_efx_fe_version?keep_after(" ")}</td>
                    </tr><tr>
                        ...
                        <td font-size="8pt"><b>Lugar Expedición</b></td>
                        <td font-size="8pt">${record.location.custrecord_efx_lugar_expedicion}</td>
                    </tr>
    ...
    <#if xml_datapay?has_content>
      ...
      <#list custom.appliedTxns as appliedTxn>
          ...
          <#assign "paymenttotal" += txnitem.amount/>
        </#list>
    ...
    <table class="itemtable" style="width: 100%; margin-top: 10px;">
        ...
        <tr style="vertical-align:baseline">
            ...
            <td align="right" colspan="6" line-height="150%">${ nsformat_rate(paymenttotal)}</td>
    ...
    <table><!-- start items -->
        ...
        <tr>
            <td align="left" colspan="5" line-height="150%">Versión: ${record.customer.custentity_efx_fe_version?keep_after(" ")}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" colspan="4" >${nsformat_rate(paymenttotal)}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" colspan="4" ><b>Tipo de exportación: </b></td>
            <td align="left" colspan="4" >${record.custbody_mx_cfdi_sat_export_type}</td>
        </tr>

    </table>

    <#if dataXML?has_content>
        <#if dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR?is_sequence>
            <#list dataXML.Complemento.Pagos.Pago.DoctoRelacionado as docDR>
                <table class="itemtable" style="width: 100%; margin-top: 10px; margin-left: 10px; margin-right: 10px;">
                    ...
                    <tr style="margin-top:6px">
                        ...
                        <td align="left" colspan="2">${docDR.atributos.IdDocumento}</td>
                        <td align="left" colspan="1">Parcialidad:</td>
                        <td align="right" colspan="1">${docDR.atributos.NumParcialidad}</td>
                    </tr>

                    <tr>
                        <td align="left" colspan="1">Serie/Folio:</td>
                        <td align="left" colspan="2">${docDR.atributos.Serie}${docDR.atributos.Folio}</td>
                        <td align="left" colspan="1">Importe del Saldo Anterior:</td>
                        <td align="right" colspan="1">${docDR.atributos.ImpSaldoAnt}</td>
                    </tr>

                    <tr>
                        <td align="left" colspan="1" line-height="150%">Moneda:</td>
                        <td align="left" colspan="2" line-height="150%">${docDR.atributos.MonedaDR}</td>
                        <td align="left" colspan="1" line-height="150%">Importe Pagado:</td>
                        <td align="right" colspan="1" line-height="150%">${docDR.atributos.ImpPagado}</td>
                    </tr>

                    <tr>
                        <td align="left" colspan="1">Tipo de Cambio:</td>
                        <td align="left" colspan="2">${docDR.atributos.EquivalenciaDR}</td>
                        <td align="left" colspan="1">Importe de Saldo Insoluto:</td>
                        <td align="right" colspan="1">${docDR.atributos.ImpSaldoInsoluto}</td>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="2">
                            ${record.custbody_mx_txn_sat_payment_term}
                        </td>
                    ...
                    <#if dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR?is_sequence>
                        <#list dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR as tax>
                            <#--  Tabla de detalle de IVA  -->
                            <tr>
                                <td id="impRel" align="left" colspan="1" style="margin-top: 2px;"><b>BaseDR</b></td>
                                <td id="impRel" align="left" colspan="1">${tax.atributos.BaseDR}</td>
                                <#--  <td align="left" colspan="1">${dataXML.Complemento.Pagos.Totales.atributos.TotalTrasladosBaseIVA16}</td>  -->
                            </tr>
                            <tr>
                                <td id="impRel" align="left" colspan="1"><b>ImpuestosDR</b></td>
                                <td id="impRel" align="left" colspan="1">${tax.atributos.TasaOCuotaDR}</td>
                            </tr>
                            <tr>
                                <td id="impRel" align="left" colspan="1"><b>Monto TotalDR</b></td>
                                <td id="impRel" align="left" colspan="1">${tax.atributos.ImporteDR}</td>
                            </tr>
                    ...
                    <#else>
                        <tr>
                            <td id="impRel" align="left" colspan="1" style="margin-top: 2px;"><b>BaseDR</b></td>
                            <td id="impRel" align="left" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR.atributos.BaseDR}</td>
                        </tr>
                        <tr>
                            <td id="impRel" align="left" colspan="1"><b>ImpuestosDR</b></td>
                            <td id="impRel" align="left" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR.atributos.TasaOCuotaDR}</td>
                        </tr>
                        <tr>
                            <td id="impRel" align="left" colspan="1"><b>Monto TotalDR</b></td>
                            <td id="impRel" align="left" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR.atributos.ImporteDR}</td>
                        </tr>
                        <tr style="border-bottom:2px;">
                            <td align="left" colspan="1"></td>
                        </tr>
                    ...
                    <#if record.custbody_efx_fe_chbx_factorage == true>
                        ...
                        <#list custom.appliedTxns as appliedTxn>
                            ...
                            <tr>
                                ...
                                <td align="right" colspan="1">${fmtc(txnitem.disc)}</td>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="1" line-height="150%">Importe Pagado:</td>
                                <td align="right" colspan="1" line-height="150%">${fmtc_NS(txnitem.disc)}</td>
        ...
        <#else>
            <table class="itemtable" style="width: 100%; margin-top: 10px; margin-left: 10px; margin-right: 10px;">
                ...
                <tr style="margin-top:6px">
                    <td align="left" colspan="1">ID del Documento:</td>
                    <td align="left" colspan="2">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.IdDocumento}</td>
                    <td align="left" colspan="1">Parcialidad:</td>
                    <td align="right" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.NumParcialidad}</td>
                </tr>

                <tr>
                    <td align="left" colspan="1">Serie/Folio:</td>
                    <#assign serie = dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.Serie>
                    <#assign folio = dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.Folio>
                    <td align="left" colspan="2">${serie}${folio}</td>
                    <td align="left" colspan="1">Importe del Saldo Anterior:</td>
                    <td align="right" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.ImpSaldoAnt}</td>
                </tr>

                <tr>
                    <td align="left" colspan="1" line-height="150%">Moneda:</td>
                    <td align="left" colspan="2" line-height="150%">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.MonedaDR}</td>
                    <td align="left" colspan="1" line-height="150%">Importe Pagado:</td>
                    <td align="right" colspan="1" line-height="150%">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.ImpPagado}</td>
                </tr>

                <tr>
                    <td align="left" colspan="1">Tipo de Cambio:</td>
                    <td align="left" colspan="2">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.EquivalenciaDR}</td>
                    <td align="left" colspan="1">Importe de Saldo Insoluto:</td>
                    <td align="right" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.atributos.ImpSaldoInsoluto}</td>
                </tr>
                ...
                <#if dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR?is_sequence>
                    <#list dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR as tax>
                        <#--  Tabla de detalle de IVA  -->
                        <tr>
                            <td align="left" colspan="1"><b>BaseDR</b></td>
                            <td align="left" colspan="1">${tax.atributos.BaseDR}</td>
                            <#--  <td align="left" colspan="1">${dataXML.Complemento.Pagos.Totales.atributos.TotalTrasladosBaseIVA16}</td>  -->
                        </tr>
                        <tr>
                            <td align="left" colspan="1"><b>ImpuestosDR</b></td>
                            <td align="left" colspan="1">${tax.atributos.TasaOCuotaDR}</td>
                        </tr>
                        <tr>
                            <td align="left" colspan="1"><b>Monto TotalDR</b></td>
                            <td align="left" colspan="1">${tax.atributos.ImporteDR}</td>
                        </tr>
                        <tr style="border-bottom:2px;">
                            <td align="left" colspan="1"></td>
                        </tr>
                ...
                <#else>
                    <tr>
                        <td align="left" colspan="1"><b>BaseDR</b></td>
                        <td align="left" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR.atributos.BaseDR}</td>
                    </tr>
                    <tr>
                        <td align="left" colspan="1"><b>ImpuestosDR</b></td>
                        <td align="left" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR.atributos.TasaOCuotaDR}</td>
                    </tr>
                    <tr>
                        <td align="left" colspan="1"><b>Monto TotalDR</b></td>
                        <td align="left" colspan="1">${dataXML.Complemento.Pagos.Pago.DoctoRelacionado.ImpuestosDR.TrasladosDR.TrasladoDR.atributos.ImporteDR}</td>
                    </tr>
                    <tr style="border-bottom:2px;">
                        <td align="left" colspan="1"></td>
                    </tr>
                        ...
                        <#list parcialidad_f_eval as parcialidad_f>
                            <#if txnitem.refnum == parcialidad_f.facturaRef>
                                ...
                                <tr>
                                    ...
                                    <td align="right" colspan="1">${fmtc(prevAmount)}</td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2" line-height="150%">${appliedTxn.currencysymbol}</td>
                                    <td align="left" colspan="1" line-height="150%">Importe Pagado:</td>
                                    <td align="right" colspan="1" line-height="150%">${fmtc_NS(txnitem.amount)}</td>
                                ...
                                <tr>
                                    ...
                                    <td align="right" colspan="1">${fmtc(impinsoluto)}</td>
                                ...
                                <#--  Tabla de detalle de IVA  -->
                                <tr>
                                    <td align="left" colspan="1">BaseDR</td>
                                    <td align="left" colspan="1">${dataXML.Complemento.Pagos.Totales.atributos.TotalTrasladosBaseIVA16}</td>
                                    <td align="left" colspan="1"><b>ImpuestosDR</b></td>
                                    <td align="left" colspan="1">${dataXML.Complemento.Pagos.Totales.atributos.TotalTrasladosImpuestoIVA16}</td>
                                    <td align="left" colspan="1"><b>Monto TotalDR</b></td>
                                    <td align="left" colspan="1">${dataXML.Complemento.Pagos.Totales.atributos.MontoTotalPagos}</td>
                                </tr>
